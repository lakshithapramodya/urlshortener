  ...
  return (
    <div className="text-white  p-10 ">
      ...
      <form onSubmit={handleSubmit} className="mt-10">
        <div className="w-full flex justify-center px-6 py-2 rounded-3xl bg-gray-200">
          <input
            value={url}
          ...
          <button
            type="submit"
            className="bg-[#00a7ca] font-bold rounded-full w-8 ml-4 flex items-center justify-center"
          >

...
export default function ShortUrl({
  ...
  return (
    <div className="mt-4 ">
      ...
      <h3 className="text-xl text-[#495e73]  mt-20 text-center font-semibold">
        "Trim the excess and snip your links with LinkSnip, the ultimate free
        URL shortener for concise communication."
      </h3>
      {/* <BottomSection /> */}
    </div>
  );

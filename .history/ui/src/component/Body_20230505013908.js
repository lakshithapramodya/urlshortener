  ...
  return (
    <div className="text-white  p-10 ">
      ...
      <form onSubmit={handleSubmit} className="mt-10">
        <div className="w-[80%] md:w-[50%] px-2 flex justify-center py-2 rounded-3xl bg-gray-200">
          <div className="flex items-center justify-center space-x-2">
            <div className="h-6 w-6 rounded-full bg-[#e3736e]" />
            <div className="h-6 w-6 rounded-full bg-[#fabf3f]" />
            <div className="h-6 w-6 rounded-full bg-[#59ca42]" />
          </div>
          <input
            value={url}

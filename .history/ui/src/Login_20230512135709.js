...
export default function Login() {
  ...
  return (
    <div>
      ...
      <div className=" min-h-screen flex flex-col justify-center items-center w-full md:w-2/3 lg:w-1/2 xl:w-2/5 pt-32">
        ...
        <form onSubmit={handleSubmit} className="mt-8 grid w-[80%] space-y-4">
          <input
            placeholder="Email"
            value={email}
